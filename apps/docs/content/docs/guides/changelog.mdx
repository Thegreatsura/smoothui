...
> This page is a curated highlight reel of major SmoothUI releases. For the
> full technical log auto-generated from conventional commits, see
> [GitHub Releases](https://github.com/educlopez/smoothui/releases) or
> [`CHANGELOG.md`](https://github.com/educlopez/smoothui/blob/main/CHANGELOG.md).
